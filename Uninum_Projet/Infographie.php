<!DOCTYPE html>
  <html>
    <head>
      <title>Cours en ligne | Infographie</title>
      <meta charset="UTF-8" />
...
$tra = array("Travaux","Lavori");
$spa = array("Espace étudiant","Spaziu Studientu");
$dev = array("Devoirs ou Examens","Duveri o Esame");
$resu = array("Rendu Travaux","Resu lavori");
 ?>
    <body id="linear-gradient">
      <div class="container-fluid">
        <header class="row">
          <div class="col-xs-12 col-sm-4 col-md-4" id="imgaccueil">
            <a href="./index.php"><img src="img/Logohorinzontalmono.png"></a>
          </div>
          <div class="nav ui li a col-xs-12 col-sm-8 col-md-8">
            <nav class="navbar">
            ...
            <li><a href="https://studia.universita.corsica/"><?php echo $etu[$langue];?></a></li>
                ...
                <a href="Infographie.php" target="_self"><img src="img/drapeau-francais.png" class="drapeau"  /></a>
                <a href="Infographie.php?lang=1" target="_self"><img src="img/drapeau-corse.png" class="drapeau"/></a>
              </ul>
            </div>
          </nav>
        </div>
      </header>
      <section class="row" class="bande">
        <div class="col-xs-12 col-sm-12 col-md-12" id="title">
          <center>
            <img src="img/Infographiebleu.png" class="icon2">
            <h1>M3205-Infographie</h1>
            <h2><?php echo $spa[$langue];?></h2>
          </center>
          <br>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4" id="a">
              <div class="dropdown">
            <a href="https://cours.universita.corsica/mon_cours.php?id_cours=D2ME65">   <img src="img/Annonces.jpg" class="img-rounded" style="width:100%"></a> 
              </div>
            </div>
            <div class="col-md-4"id="a">
           <a href="https://cours.universita.corsica/outils/documents/index.php?id_cours=D2ME65">  <img src="img/Documents.jpg" class="img-rounded" style="width:100%"></a> 
            </div>
            <div class="col-md-4" id="a">
              <a href="Travaux.php">
                <img src="img/Travaux.jpg" class="img-rounded" style="width:100%">
              </a>
            </div>
            <div class="col-md-4" id="a" >
              <a href="https://discord.gg/ujv6qV6sVB">
                <img src="img/Discord.jpg" class="img-rounded" style="width:100%">
              </a>
            </div>
            <div class="col-md-4" id="a">
              <a href="https://teams.microsoft.com/_#/school/conversations/M4204%20-%20Projet%20tutor%C3%A9?threadId=19:550d4551c9d94cf6a4a4889cee4a67d8@thread.tacv2&ctx=channel">
                <img src="img/TeamsB.jpg" class="img-rounded" style="width:100%">
              </a>
            </div>
          </div>
        </div>
    ...
    <footer class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-4" id="discord">
        <a href="https://teams.microsoft.com/l/channel/19%3acedccaa959aa45629f62253028a1c40b%40thread.tacv2/G%25C3%25A9n%25C3%25A9ral?groupId=15698ea5-74f0-4e7f-a72a-aa0d30116650&tenantId=98cf6e20-76a4-49cf-b24b-5c2c7b530ca0" target="_blank">
          <img src="img/Teams.png"></a>
      </div>
      <center>
      <div class="col-xs-12 col-sm-12 col-md-12" >
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
