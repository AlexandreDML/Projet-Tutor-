...
<html>
  <head>
    <title>Emploi du temps | DUT Métier du Multimédia et de l'Internet 2020/2021</title>
    <meta charset="UTF-8" />
...
$emp = array("Emploi du temps personnel","Spartitempu");
$sem = array("Semaine du","Settimana di");
$au = array("au","à");
 ?>
  <body id="linear-gradient">
    <div class="container-fluid">
      <header class="row">
        ...
        <div class="nav ui li a col-sm-8 col-lg-8">
          <nav class="navbar">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
             ...
             <li><a href="https://studia.universita.corsica/"><?php echo $etu[$langue];?></a></li>
                ...
                <a href="EDT.php" target="_self"><img src="img/drapeau-francais.png" class="drapeau"  /></a>
                <a href="EDT.php?lang=1" target="_self"><img src="img/drapeau-corse.png" class="drapeau" /></a>
              </ul>
            </div>
          </nav>
        </div>
      ...
      <section class="row">
        <div class="col-xs-12 col-sm-12 col-md-12" id="title">
           <center><img src="img/ICONEDT.png" class="icon"></center>
          <center><h1><?php echo $emp[$langue];?></h1></center>
          <center><h2><?php echo $sem[$langue];?> 11/01 <?php echo $au[$langue];?> 17/01</h2></center>
            <br>
        </div>
      </section>
      <section class="row" id="mid">
        ...
        <section class="row " id="corps">
          <div class="container">
            <div class="row">
        			<div class="col-xs-12 col-sm-12 col-md-12" id="jour">
      				<img src="img/jour.png" >
              </div>
              <div class="col-xs-2 col-sm-2 col-md-2" id="heures">
      			       <img src="img/heures.png">
              </div>

              <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                <div class="dropdown">
                  <img src="img/InfographieB.png">
                  <div class="dropdown-content">
                  <a href="./Infographie.php">Cours en ligne</a>
              ...
              <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2">
                <div class="dropdown">
                    <img src="img/WebV.png">
                  <div class="dropdown-content">
                  <a href="./Infographie.html">Cours en ligne</a>
                  <a href="https://discord.gg/ujv6qV6sVB">Discord</a>
                  <a href="#">Teams</a>
                  </div>
                </div>
              ...
              <div class="col-xs-2 col-sm-2 col-md-2">
      				      <img src="img/InfographieR.png">
              </div>
              <div class="col-xs-2 col-sm-2 col-md-2">
      			        <img src="img/InfographieV.png">
              </div>
              ...
              <div class="col-xs-2 col-sm-2 col-md-2">
      			        <img src="img/RéseauxB.png">
              </div>
              <div class="col-xs-2 col-sm-2 col-md-2">
      			        <img src="img/RéseauxV.png">
              </div>
              <div class="col-xs-2 col-sm-2 col-md-2">
      		          <img src="img/CorseR.png">
              </div>
              <div class="col-xs-2 col-sm-2 col-md-2">
                    <img src="img/InfographieV.png">
              </div>
              ...
              <div class="col-xs-2 col-sm-2 col-md-2">
          		...
          		<div class="col-xs-2 col-sm-2 col-md-2">
          					<img src="img/CorseB.png">
          		</div>
          		<div class="col-xs-2 col-sm-2 col-md-2">
          					<img src="img/CorseB.png">
          		</div>
          		<div class="col-xs-2 col-sm-2 col-md-2">
          					<img src="img/RéseauxR.png">
          		</div>
          		<div class="col-xs-2 col-sm-2 col-md-2">
          					<img src="img/CorseB.png">
          		</div>
