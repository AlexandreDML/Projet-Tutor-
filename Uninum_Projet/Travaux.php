...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="Rendu.php">
    ...
    <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav navbar-nav">
                ...
                <li><a href="https://fundazione.universita.corsica/"><?php echo $fond[$langue];?></a></li>
                 <a href="Travaux.php" target="_self"><img src="img/drapeau-francais.png" class="drapeau"  /></a>
                <a href="Travaux.php?lang=1" target="_self"><img src="img/drapeau-corse.png" class="drapeau" /></a>
              </ul>
            </div>
          </nav>
        </div>
      ...
      <section class="row">
        <div class="col-xs-12 col-sm-12 col-md-12" id="title">
           <center><img src="img/Travauxbleu.png" class="icon2"></center>
          <center>
            <h1><?php echo $tra[$langue];?></h1>
      ...
      <section class="row" id="mid">
        ...
        <section class="row " id="corps">
          <div class="container">
            <div class="row">
            <center> <div class="col-xs-12 col-sm-12 col-md-6" class="box" style="background: linear-gradient(0deg, #c7e3ff, white); border-radius: 20px; margin-top: 20px;">
               <h1><?php echo $dev[$langue];?></h1>
                <p> <strong>M.Stara</strong> Affiche Pachjella <strong style="color: #116197">20/03/21</strong></p>
                <p> <strong>Mme.Uccelli</strong> Identité Visuelle <strong style="color: #116197">29/03/21</strong></p>


        </div></center>
        <div class="col-xs-12 col-sm-12 col-md-6" class="box2" style="background: linear-gradient(0deg, #c7e3ff, white); padding: 30px; margin-top: 20px;border-radius: 20px;" >
            <center>  <h1><?php echo $resu[$langue];?></h1></center>
              <center><input type="file" name="fichier"/></center>
        </div>
         </div>
          </div>
      </section>
