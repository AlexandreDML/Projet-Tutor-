...
<html>
  <head>
    <title>Cours en ligne | Uninum</title>
    <meta charset="UTF-8" />
...
$esp = array("Espace étudiant","Spaziu Studientu");
$cor = array("Cours En ligne","Corsi in Linea");
$doc = array("Documents","Documenti");
$tra = array("Travaux","Travagli");
$ano = array("Annonces","Annuncia");
 ?>
    ...
    <div class="container-fluid">
        ...
        <div class="nav ui li a col-xs-12 col-sm-8 col-md-8">
          <nav class="navbar">
            ...
            <li><a href="https://studia.universita.corsica/"><?php echo $etu[$langue];?></a></li>
                ...
                <a href="Cours_En_Ligne.php" target="_self"><img src="img/drapeau-francais.png" class="drapeau"  /></a>
                <a href="Cours_En_Ligne.php?lang=1" target="_self"><img src="img/drapeau-corse.png" class="drapeau" /></a>
              </ul>
            </div>
          </nav>
        </div>
      ...
      <section class="row">
        <div class="col-xs-12 col-sm-12 col-md-12" id="title">
           <center><img src="img/Cel.png" class="icon2"></center>
          <center><h1><?php echo $cor[$langue];?></h1></center>
          <center><h2><?php echo $esp[$langue];?></h2></center>
            <br>
        </div>
      </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-4" id="a">
                <div class="dropdown">
                  <a href="./Infographie.php">
                    <img src="img/Infographie.jpg" class="img-rounded" style="width:100%">
                  </a>
                  <div class="dropdown-content">
                  <a href="https://cours.universita.corsica/mon_cours.php?id_cours=D2ME65"><?php echo $ano[$langue];?><span class="badge">5</span></a>
                  <a href="https://cours.universita.corsica/outils/documents/index.php?id_cours=D2ME65"><?php echo $doc[$langue];?></a>
                  <a href="./Travaux.php"><?php echo $tra[$langue];?></a>
                  <a href="https://discord.gg/ujv6qV6sVB">Discord</a>
                  <a href="#">Teams</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4" id="a">
                <div class="dropdown">
                    <img src="img/Droit.jpg" class="img-rounded" style="width:100%">
                  <div class="dropdown-content">
                  <a href="#"><?php echo $ano[$langue];?></span></a>
                  <a href="#"><?php echo $doc[$langue];?></a>
                  <a href="#"><?php echo $tra[$langue];?></a>
                  <a href="https://discord.gg/zHJpeWBzHv">Discord</a>
                  <a href="#">Teams</a>
                  </div>
              </div>
            </div>
              <div class="col-md-4" id="a">
                <div class="dropdown">
                  <img src="img/Culture.jpg" class="img-rounded" style="width:100%">
                  <div class="dropdown-content">
                  <a href="#"><?php echo $ano[$langue];?></a>
                  <a href="#"><?php echo $doc[$langue];?></a>
                  <a href="#"><?php echo $tra[$langue];?></a>
                  <a href="https://discord.gg/cHvqVrNVUJ">Discord</a>
                  <a href="#">Teams</a>
                  </div>
              </div>
            </div>
              <div class="col-md-4" id="a">
                <div class="dropdown">
                  <img src="img/EMN.jpg" class="img-rounded" style="width:100%">
                  <div class="dropdown-content">
                  <a href="#"><?php echo $ano[$langue];?></a>
                  <a href="#"><?php echo $doc[$langue];?></a>
                  <a href="#"><?php echo $tra[$langue];?></a>
                  <a href="https://discord.gg/J3bhs3VHu2">Discord</a>
                  <a href="#">Teams</a>
                  </div>
                </div>
              </div>
              <div class="col-md-4" id="a">
                <div class="dropdown">
                  <img src="img/Anglais.jpg" class="img-rounded" style="width:100%">
                  <div class="dropdown-content">
                  <a href="#"><?php echo $ano[$langue];?></a>
                  <a href="#"><?php echo $doc[$langue];?></a>
                  <a href="#"><?php echo $tra[$langue];?></a>
                  <a href="https://discord.gg/rRANKDFn7Q">Discord</a>
                  <a href="#">Teams</a>
                  </div>
              </div>
          </div>
